...
public class Client {
    public static void main(String args[]) {
        ProductFactory productAFactory = FactoryProducer.getProductFactory(ProductAFactory.NAME);
        ...
        ProductFactory productBFactory = FactoryProducer.getProductFactory(ProductBFactory.NAME);
